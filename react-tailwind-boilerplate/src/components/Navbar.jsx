...
const Navbar = () => {
    ...
    return (
        <div 
            className={`flex justify-between items-center px-4 text-foreground py-4 mb-10 fixed top-0 left-0 right-0 z-30 transition-colors duration-300 ${scrolled ? 'bg-background shadow-md' : 'bg-transparent'}`}
        >
